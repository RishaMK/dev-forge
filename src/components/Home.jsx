        ...
        <>
            <div className='flex gap-5 py-24 mb-14 justify-between items-center'>
                <div className='flex flex-col gap-5'>
                    ...
                    <button className='w-56 p-2 bg-blue-600 rounded-lg flex justify-center items-center transition duration-700 hover:scale-110'>
                    ...
                    <button className='w-56 p-2 flex items-center justify-center bg-slate-300/30 rounded-lg transition duration-700 hover:scale-110'>
                        Brochure&nbsp;
